...
export class ShiftwisedataComponent {
  ...
  GetAttendanceList() {
    ...
    this.ApiURL = "Performance/GetDailyAttendance?AdminID=" + this.UserID + "&BranchID=" + this.shiftdata.branch + "&Date=" + this.shiftdata.date + "&ListType=" + shiftname + "&DeptID=" + this.shiftdata.department;
