...
import { CashierExpenseRoutingModule } from './cashier-expense-routing.module';

@NgModule({
  declarations: [DatewiseComponent,ListComponent,MonthwiseComponent,EmployeewiseComponent, EmployeeComponent, ExpenseComponent, BillComponent, ConfirmationComponent, ConfirmationexpensewiseComponent],
  imports: [
    CommonModule,
    NgSelectModule,
    MatInputModule,
    ...
    MatTabsModule,
    EmployeeWiseModule,
    CashierExpenseRoutingModule

  ]
})
export class CashierExpenseModule { }
