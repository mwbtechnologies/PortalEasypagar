...
@Component({
  selector: 'app-trainerwiseupdate',
  templateUrl: './trainerwiseupdate.component.html',
  styleUrls: ['./trainerwiseupdate.component.css']
})
export class TrainerwiseupdateComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TrainerwiseupdateComponent>,
  ...
  updateStatus() {
    if (this.Status == 'Pending') {
      ...
      this._commonservice.ApiUsingPost("TraniningMaster/TrainesListUpDateByAdmin", json).subscribe((data) => {
