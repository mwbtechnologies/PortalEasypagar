...
export class CommonTableComponent  implements OnInit,OnChanges {
 ...
 let validDateHeader:any = ["LoanIssuedDate","DeleteDate","DeletedDate",
      ...
      "TrainerStartDate","TrainerEndDate","DeductionDate","SessionStartDate","SessionEndDate","FirstDeductionDate", "LastDeductionDate","LastEstimatedDate"]
  ...
  //    }
    ...
    const addStyledRow = (text: string, fontSize: number, bold: boolean) => {
        ...
        row[0] = {
            ...
            s: {
                font: { bold: bold },
                fill: { fgColor: { rgb: "ffffff" } }, // Optional: white background
                border: {
                    top: { style: 'thin', color: { rgb: '000000' } },
                    bottom: { style: 'thin', color: { rgb: '000000' } },
                    left: { style: 'thin', color: { rgb: '000000' } },
