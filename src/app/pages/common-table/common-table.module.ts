...
import { ColumnSelection, CommonTableComponent, DownloadReport } from './common-table.component';
...
@NgModule({
  declarations: [CommonTableComponent,DownloadReport, ColumnSelection],
  imports: [
    CommonModule,
    MatTableModule,
    // NgxDropzoneModule,
