...
@Component({
  selector: 'app-allocate-modules',
  templateUrl: './allocate-modules.component.html',
  styleUrls: ['./allocate-modules.component.css']
})
export class AllocateModulesComponent implements OnInit {
  form: any;
